...
import { Card, Select, Button, Space, Tag, Input, message, Tooltip, Table, Drawer, Statistic, Row, Col, Progress, Descriptions } from 'antd';
import { 
  ReloadOutlined, 
  DownloadOutlined, 
  ZoomInOutlined, 
    ...
    const demoTasks: Task[] = [
      {
        ...
        priority: 'high',
        daily_workload: [
          { date: '2024-01-05', device: 'R-001反应釜', work_content: '基坑开挖', workers: 8, hours: 8, completed: true },
          { date: '2024-01-06', device: 'R-001反应釜', work_content: '基坑开挖', workers: 8, hours: 8, completed: true },
          { date: '2024-01-07', device: 'R-001反应釜', work_content: '基底处理', workers: 6, hours: 8, completed: true },
          { date: '2024-01-08', device: 'R-001反应釜', work_content: '钢筋绑扎', workers: 10, hours: 8, completed: true },
          { date: '2024-01-09', device: 'R-001反应釜', work_content: '钢筋绑扎', workers: 10, hours: 8, completed: true },
        ],
      },
      {
        id: 'T-002',
        ...
        priority: 'critical',
        daily_workload: [
          { date: '2024-01-25', device: 'R-001反应釜', work_content: '吊装准备', workers: 12, hours: 8, completed: true },
          { date: '2024-01-26', device: 'R-001反应釜', work_content: '主体吊装', workers: 15, hours: 10, completed: true },
          { date: '2024-01-27', device: 'R-001反应釜', work_content: '就位调整', workers: 10, hours: 8, completed: true },
          { date: '2024-01-28', device: 'R-001反应釜', work_content: '固定焊接', workers: 8, hours: 8, completed: true },
          { date: '2024-01-29', device: 'R-001反应釜', work_content: '固定焊接', workers: 8, hours: 8, completed: false },
        ],
      },
      {
        id: 'T-003',
        ...
        priority: 'high',
        daily_workload: [
          { date: '2024-01-20', device: 'H-001换热器', work_content: '设备检查', workers: 4, hours: 6, completed: true },
          { date: '2024-01-21', device: 'H-001换热器', work_content: '基础准备', workers: 6, hours: 8, completed: true },
          { date: '2024-01-22', device: 'H-002换热器', work_content: '设备检查', workers: 4, hours: 6, completed: true },
          { date: '2024-01-23', device: 'H-002换热器', work_content: '基础准备', workers: 6, hours: 8, completed: true },
          { date: '2024-01-24', device: 'H-001换热器', work_content: '吊装安装', workers: 10, hours: 8, completed: false },
        ],
      },
      {
        id: 'T-004',
        ...
        priority: 'medium',
        daily_workload: [
          { date: '2024-02-01', device: 'P-001管道', work_content: '预制加工', workers: 8, hours: 8, completed: true },
          { date: '2024-02-02', device: 'P-001管道', work_content: '预制加工', workers: 8, hours: 8, completed: true },
          { date: '2024-02-03', device: 'P-002管道', work_content: '预制加工', workers: 8, hours: 8, completed: true },
          { date: '2024-02-04', device: 'P-001管道', work_content: '现场焊接', workers: 6, hours: 8, completed: false },
        ],
      },
    ];
    setTasks(demoTasks);
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            ...
            <div style={{ 
              ...
              <span style={{ fontWeight: 600, color: '#1890ff' }}>{filteredTasks.length}</span> 个任务
              <span style={{ color: '#d9d9d9' }}>|</span>
              <span style={{ fontWeight: 600, color: '#52c41a' }}>{completedTasks}</span> 已完成
              <span style={{ color: '#d9d9d9' }}>|</span>
              <span>平均 <strong style={{ color: '#1890ff' }}>{avgProgress}%</strong></span>
            </div>
          </div>
          ...
          <Space size="middle">
            ...
            <Button icon={<DownloadOutlined />} style={{ borderRadius: 4 }}>导出Excel</Button>
            <Tooltip title="点击任务条查看详细信息">
              <Button icon={<ClockCircleOutlined />} style={{ borderRadius: 4 }}>使用说明</Button>
            </Tooltip>
          </Space>
        </div>
          ...
          <div style={{ 
            ...
            <Space size="large">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div style={{ width: 12, height: 12, borderRadius: '50%', background: '#52c41a', boxShadow: '0 0 4px rgba(82, 196, 26, 0.5)' }} />
                <span style={{ fontSize: 13, color: '#595959' }}>每日已完成</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                <div style={{ width: 12, height: 12, borderRadius: '50%', background: '#faad14', boxShadow: '0 0 4px rgba(250, 173, 20, 0.5)' }} />
                <span style={{ fontSize: 13, color: '#595959' }}>每日未完成</span>
              </div>
            </Space>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <Tag color="processing" style={{ margin: 0 }}>{inProgressTasks} 进行中</Tag>
              <Tag color="success" style={{ margin: 0 }}>{completedTasks} 已完成</Tag>
              <Tag color="blue" style={{ margin: 0 }}>💡 点击任务条查看详情</Tag>
            </div>
          </div>
          ...
          title={
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12, color: '#8c8c8c', fontWeight: 'normal' }}>每日工作量详细追踪</div>
              </div>
            </div>
          }
          placement="right"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              >
                <Descriptions column={2} size="small">
                  <Descriptions.Item label={<span><UserOutlined /> 负责人</span>}>
                    <Tag color="blue">{selectedTask.assignee}</Tag>
                  </Descriptions.Item>
                  <Descriptions.Item label={<span><CheckCircleOutlined /> 状态</span>}>
                    <Tag color={selectedTask.status === 'completed' ? 'success' : selectedTask.status === 'in_progress' ? 'processing' : 'default'}>
                      {selectedTask.status === 'completed' ? '已完成' : selectedTask.status === 'in_progress' ? '进行中' : '待开始'}
                    </Tag>
                  </Descriptions.Item>
              ...
              <Row gutter={12}>
                <Col span={8}>
                  <Card 
                    variant="borderless"
                    style={{ borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.06)', textAlign: 'center' }}
                  ...
                  columns={[
                    {
                      ...
                      render: (date: string) => (
                        <div>
                          ...
                          <div style={{ fontSize: 12, color: '#8c8c8c' }}>{dayjs(date).format('ddd')}</div>
                        </div>
                      ),
                    },
                    {
                    ...
                    },
                    {
                      ...
                      render: (workers: number) => (
                        <Tag icon={<TeamOutlined />} color="cyan">{workers}人</Tag>
                      ),
                    },
                    {
                      title: '工时',
