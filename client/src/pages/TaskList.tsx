...
import { Card, Row, Col, Button, Space, Tag, Progress, Empty, Modal, Form, Input, DatePicker, Select, InputNumber, Dropdown, message, Statistic } from 'antd';
import { 
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12 }}>
                  <Space size={4}>
                    ...
                    <span style={{ fontSize: 12, color: '#595959' }}>{task.assignee || '未分配'}</span>
                  </Space>
                  <Space size={4}>
